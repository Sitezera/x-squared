    ...
    <div className="project-page">
      ...
      <div className="content-section">
        <div className="title-section">
          <h2 className="project-title">Nava Harihara</h2>
        ...
        <div className="main-image-container">
          <img src="/assets/Screenshot 2025-11-20 at 3.35.42 PM.png" alt="Nava Harihara Main" className="main-image" />
        </div>
        <div className="dual-image-container">
          <img src="/assets/WhatsApp Image 2025-11-22 at 17.15.52.jpeg" alt="Nava Harihara Additional" className="dual-image" />
          <img src="/assets/1_43 - Photo.jpg" alt="Nava Harihara Additional 2" className="dual-image" />
        </div>
        <div className="single-image-container">
          <img src="/assets/WhatsApp Image 2025-11-21 at 20.39.10.jpeg" alt="Nava Harihara Additional 3" className="single-image" />
        </div>
        <section className="project-details">
          <div className="details-container">
            <div className="details-left">
              <div className="label">PROJECT</div>
              <div className="info-text">Nava Harihara</div>
              <div className="info-text">Project near Harihara, Karnataka</div>
              <div className="info-text">Size: 25 Acres</div>
            </div>
